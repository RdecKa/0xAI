...
func (mcts *MCTS) GenSamples(outputFile *os.File, treasholdN uint, gridChan chan []uint32, resultChan chan [2][]int) ([]*tree.Node, error) {
...
func genSamples(node *tree.Node, outputFile *os.File, treasholdN uint, gridChan chan []uint32, resultChan chan [2][]int) []*tree.Node {
